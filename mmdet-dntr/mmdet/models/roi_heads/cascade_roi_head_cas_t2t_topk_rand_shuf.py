...
class Cascade_t2t_evit_rand_shuf_RoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(Cascade_t2t_evit_rand_shuf_RoIHead, self).__init__(
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        t2t_feats = token_to_token(bbox_feats, random_shuffle=True)

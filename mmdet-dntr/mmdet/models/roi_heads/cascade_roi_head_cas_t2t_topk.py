...
class Cascade_t2t_evit_RoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(Cascade_t2t_evit_RoIHead, self).__init__(
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        feats_cls = torch.cat((cls_token, t2t_feats_cls, t2t_feats_bbox), dim=1)

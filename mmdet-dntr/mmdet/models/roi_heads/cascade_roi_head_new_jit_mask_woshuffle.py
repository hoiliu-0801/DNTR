...
class Cascade_t2t_new_jit_mask_woshuffle_RoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(Cascade_t2t_new_jit_mask_woshuffle_RoIHead, self).__init__(
        ...
        ###### aitod dataset #####
        self.t2t_cls_head = ModuleList([nn.Linear(9*128, 11) for _ in range(self.num_stages)])
        ##### visdrone dataset ###
